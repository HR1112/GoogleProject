...
public class VideoPlayer {
  ...
  public void pauseVideo() {
    ...
    if (currentPlayingVideo != null && currentPlayingVideo.getPaused() == false){
      videoLibrary.getVideo(currentPlayingVideo.getVideoId()).setPaused(true);
      System.out.println("Pausing video: "+currentPlayingVideo.getTitle());
      videoLibrary.getVideo(currentPlayingVideo.getVideoId());
    } else if (currentPlayingVideo.getPaused()) {
